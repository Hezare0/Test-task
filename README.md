...
127.0.0.1
```
База данных PostgreSQL доступена по адресу вашего сервера с портом 5432

```
127.0.0.1:5432
```

PgAdmin доступен по адресу вашего сервера с портом 5050
...
Для проверки тестового задания с помощью миграций были добавленны тестовые записи в сущности базы данных

Пользователь для тестирования функций админа:
